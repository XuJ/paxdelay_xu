...
load data
infile 'Origin_and_Destination_Survey_DB1BCoupon_2008_1.csv'
infile 'Origin_and_Destination_Survey_DB1BCoupon_2008_2.csv'
infile 'Origin_and_Destination_Survey_DB1BCoupon_2008_3.csv'
infile 'Origin_and_Destination_Survey_DB1BCoupon_2008_4.csv'
replace
into table paxdelay.db1b_coupons_2008
