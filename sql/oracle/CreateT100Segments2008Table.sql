CREATE TABLE T100_SEGMENTS_2008
(
...
create bitmap index bmx_t100_segments_08_cym
  on t100_segments_2008(carrier, year, month)
  tablespace users;

create bitmap index bmx_t100_segments_08_cymod
  on t100_segments_2008(carrier, year, month, origin, destination)
  tablespace users;

update t100_segments_2008
set carrier = 'US'
where carrier = 'HP';
