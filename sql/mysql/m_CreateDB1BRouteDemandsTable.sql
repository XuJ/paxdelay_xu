drop table if exists temp_db1b_route_demands;

create table temp_db1b_route_demands
...
create index idx_temp_db1b_rd_yqucs
  on temp_db1b_route_demands(year, quarter, first_ucs_id, last_ucs_id);

drop table if exists db1b_ticketed_route_demands;

create table db1b_ticketed_route_demands
(
...
insert into db1b_ticketed_route_demands
(
...
drop table if exists db1b_route_demands;

create table db1b_route_demands
(
  year numeric(4) not null,
  quarter int not null,
  num_flights int not null,
...
insert into db1b_route_demands
...
create index idx_db1b_route_demands_c1yqodnf
  on db1b_route_demands(year, quarter, num_flights, first_operating_carrier, origin, destination);

create index idx_db1b_route_demands_c1c2yqodc
