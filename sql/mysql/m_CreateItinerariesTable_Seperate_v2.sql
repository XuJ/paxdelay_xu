...
drop table if exists itineraries_1;

create table itineraries_1
(
  id integer not null auto_increment, primary key (id),
  year numeric(4) not null,
  quarter int not null,
...
insert into itineraries_1
(  year, quarter, month, day_of_month, day_of_week, hour_of_day, minutes_of_hour, num_flights, first_operating_carrier,  
  origin, connection, 
  planned_departure_time,
  planned_departure_tz,
  planned_departure_local_hour,
...
select 
	...
	ti.first_flight_id as first_flight_id, 
	ti.second_flight_id as second_flight_id,
...
select 
	ti1.year as year,
	ti1.quarter as quarter,
	ti1.month as month,
	ti1.day_of_month as day_of_month,
	ti1.day_of_week as day_of_week,
	ti1.hour_of_day as hour_of_day,
	ti1.minutes_of_hour as minutes_of_hour,
	ti1.num_flights as num_flights, 

	case when ti1.first_operating_carrier <> ft2.carrier
		then 1
		else 0
	end as multi_carrier_flag,

	ti1.first_operating_carrier as first_operating_carrier,
	ft2.carrier as second_operating_carrier, 
	ti1.origin as origin,
	ti1.connection as connection,
	ft2.destination as destination, 

	ti1.planned_departure_time as planned_departure_time,
	ti1.planned_departure_tz as planned_departure_tz,
	ti1.planned_departure_local_hour as planned_departure_local_hour,
	...
	TIMESTAMPDIFF(minute, ft2.planned_departure_time, ti1.first_planned_arrival_time) as layover_duration,
	ti1.first_flight_id as first_flight_id, 
	ti1.second_flight_id as second_flight_id
from itineraries_1 ti1
join flights ft2 on ft2.id = ti1.second_flight_id;
