...
public class CreateRouteDemandsTable {
	   ...
	   try{
	      ...
	      sql.add("drop table if exists temp_route_demands");
	      sql.add("create table temp_route_demands\n" + 
	      ...
	      sql.add("create index idx_temp_rd_yqucs\n" + 
	      		"  on temp_route_demands(year, quarter, first_ucs_id, last_ucs_id)");
	      sql.add("drop table if exists ticketed_route_demands");
	      sql.add("create table ticketed_route_demands\n" + 
	      		"(\n" + 
	      		...
	      		")\n" + 
	      		"ENGINE = MyISAM");
	      sql.add("insert into ticketed_route_demands\n" + 
	      		"(\n" + 
	      ...
	      sql.add("drop table if exists route_demands");
	      sql.add("create table route_demands\n" + 
	      		"(\n" + 
	      		"  year numeric(4) not null,\n" + 
	      		"  quarter int not null,\n" + 
	      		"  num_flights int not null,\n" + 
	      		...
	      		")\n" + 
	      		"ENGINE = MyISAM");
	      sql.add("insert into route_demands\n" + 
